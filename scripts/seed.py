...
def seed() -> None:
    ...
    with SessionLocal() as session:
        ...
        records: list[tuple[dict, list[Offer]]] = [
            (
                dict(
                    vin=_vin(1), year=2024, make="Honda", model="Civic",
                    trim="Sport", msrp=Decimal("27500.00"),
                    dealer_price=Decimal("26200.00"), mileage=12,
                    condition=VehicleCondition.NEW, stock_number="H24001",
                    body_style="sedan",
                ),
                [
                    Offer(
                        type=OfferType.LEASE, monthly_payment=Decimal("299.00"),
                        term_months=36, due_at_signing=Decimal("2999.00"),
                        residual=Decimal("16500.00"), apr=Decimal("4.90"),
                        expiration_date=future, jurisdiction="US-CA",
                    ),
                ],
            ),
            (
                dict(
                    vin=_vin(2), year=2024, make="Honda", model="Accord",
                    trim="EX-L", msrp=Decimal("34100.00"),
                    dealer_price=Decimal("32750.00"), mileage=8,
                    condition=VehicleCondition.NEW, stock_number="H24002",
                    body_style="sedan",
                ),
                [
                    Offer(
                        type=OfferType.FINANCE, apr=Decimal("3.90"),
                        term_months=60, monthly_payment=Decimal("589.00"),
                        down_payment=Decimal("3000.00"), expiration_date=future,
                        jurisdiction="US-CA",
                    ),
                ],
            ),
            (
                dict(
                    vin=_vin(3), year=2023, make="Honda", model="CR-V",
                    trim="EX", msrp=Decimal("33200.00"),
                    dealer_price=Decimal("31900.00"), mileage=18234,
                    condition=VehicleCondition.CERTIFIED, stock_number="H23003",
                    body_style="suv",
                ),
                [
                    Offer(
                        type=OfferType.CASH, expiration_date=future,
                        jurisdiction="US-CA",
                    ),
                ],
            ),
            (
                dict(
                    vin=_vin(4), year=2022, make="Honda", model="Pilot",
                    trim="Touring", msrp=Decimal("48900.00"),
                    dealer_price=Decimal("44500.00"), mileage=31420,
                    condition=VehicleCondition.USED, stock_number="H22004",
                    body_style="suv",
                ),
                [
                    Offer(
                        type=OfferType.REBATE, down_payment=Decimal("2500.00"),
                        expiration_date=future, jurisdiction="US-CA",
                    ),
                ],
            ),
